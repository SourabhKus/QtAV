...
public Q_SLOTS:
     ...
     */
    void setStopPosition(qint64 pos = 0); //Sourabh  std::numeric_limits<qint64>::max());
    /*!
     * \brief setTimeRange
     * Set startPosition and stopPosition. Make sure start <= stop.
     */
    void setTimeRange(qint64 start, qint64 stop = 0); //Sourabh std::numeric_limits<qint64>::max() );
